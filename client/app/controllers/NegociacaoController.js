...
export class NegociacaoController {
  constructor() {
    ...
    this._inputValor = $('#valor'); // const self = this;
    ...
    this._mensagem = new Bind(new Mensagem(), new MensagemView('#mensagemView'), 'texto'); // this._negociacoesView = new NegociacoesView('#negociacoes');
  ...
  adiciona(event) {
    try {
      ...
      }).catch(err => this._mensagem.texto = err); // this._negociacoesView.update(this._negociacoes);
      // this._mensagemView.update(this._mensagem);
    } catch (err) {
      console.log(err);
  ...
  _criaNegociacao() {
    return new Negociacao(DateConverter.paraData(this._inputData.value), parseInt(this._inputQuantidade.value), parseInt(this._inputValor.value));
  }
  ...
  apaga() {
    ...
    this._negociacoes.esvazia(); // this._negociacoesView.update(this._negociacoes);


    this._mensagem.texto = 'Negociações foram apagadas com sucesso'; // this._mensagemView.update(this._mensagem);
  }
  ...
  importaNegociacoes() {
    ...
    }).catch(err => this._mensagem.texto = err); // SOME / some() -> itera em cada elemento de uma lista. 
